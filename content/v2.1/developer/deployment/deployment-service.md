...
If you are deploying your own application, please refer to the <%= link_to "Deploying your application on Ubuntu", "developer/manual-ubuntu" %> or the <%= link_to "Deploying your application on Heroku", "developer/heroku" %> Guides for more.
