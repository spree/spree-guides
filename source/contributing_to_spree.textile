...
If you are filing an issue and supplying a patch at the same time, please file a "Pull Request":#creating-a-pull-request instead. The pull request will also create an issue at the same time but its superior to just creating an issue because the code and issue can be linked.
